...
LOAD DATA LOCAL INFILE 'D:/SMUGeneralFiles/Current_Semester/SPM/Project/SampleData/bid.csv' INTO TABLE BID FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'D:/SMUGeneralFiles/Current_Semester/SPM/Project/SampleData/course.csv' INTO TABLE COURSE FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'D:/SMUGeneralFiles/Current_Semester/SPM/Project/SampleData/course_completed.csv' INTO TABLE COURSE_COMPLETED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'D:/SMUGeneralFiles/Current_Semester/SPM/Project/SampleData/prerequisite.csv' INTO TABLE PREREQUISITE FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'D:/SMUGeneralFiles/Current_Semester/SPM/Project/SampleData/section.csv' INTO TABLE SECTION FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
LOAD DATA LOCAL INFILE 'D:/SMUGeneralFiles/Current_Semester/SPM/Project/SampleData/student.csv' INTO TABLE STUDENT FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;
